...
<div class='containter'>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ 'Change Administrator Password' }}</div>
                    <div class="card-body">
                        <form method='post' id="form_login" action="{{route('admin_re.change_password',['id'=>$user->id])}}" >
            {{csrf_field()}}
            ...
            @if(!(Gate::forUser(Auth::guard('admin')->user())->allows('super-admin')))
            {{----Old Password----}}
            <div class="form-group row">
